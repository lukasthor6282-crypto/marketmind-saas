...
def gerar_resumo_executivo(resumo, score_info):
    return (
        ...
        f"com preço mediano de R$ {resumo['preco_mediano']}, "
        f"preço médio de R$ {resumo['preco_medio']}, "
        ...
        f"O score final foi {score_info['score']}, indicando "
        f"{score_info['nivel_oportunidade']} oportunidade."
    )
